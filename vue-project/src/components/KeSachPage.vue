<template>
    ...
    <!-- Bảng dữ liệu -->
    <v-data-table :headers="dynamicHeaders" :items="filteredItems" density="compact" :item-key="id_ke" fixed-header height="400px"
        :header-props="({ style: 'background-color: #4169E1; color: #ffffff;' })" @click:row="onRowClick" hover>
        ...
        <v-card>
            ...
            <v-card-text>
                <v-form ref="form">
                    ...
                    <v-text-field v-model="currentItem.sl_loai" label="Số lượng loại" required></v-text-field>
...
const headers = [
    ...
    { title: 'Số lượng loại', align: 'end', key: 'sl_loai' },
    { title: 'Tình trạng', align: 'end', key: 'is_full' },
];
...
function onRowClick(event, item) {
    console.log('Row clicked:', item.internalItem.columns.id_ke);
}
</script>
